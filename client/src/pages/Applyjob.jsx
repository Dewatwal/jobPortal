        ...
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-100 border border-sky-500 rounded-xl">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left text-neutral-700">
                ...
                <div className="flex flex-row flex-wrap max-md:justify-center gap-y-2  gap-6 items-center text-gray-500 mt-4">
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto mac-md:text-center ">
              <button className="bg-blue-800 p-2  text-white rounded hover:bg-blue-600">
                Apply Now
              </button>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              <button className="bg-blue-800 p-2  text-white rounded hover:bg-blue-600 mt-10">
                Apply Now
              </button>
            </div>
